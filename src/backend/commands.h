...
/* Install the 34 console commands. Idempotent (one-shot latch). Guards add_command && cmdsys && printf;
 ...
 * Returns the number of commands registered (0 on SKIP). Emits "B2: registered N/34 console commands".
 */
