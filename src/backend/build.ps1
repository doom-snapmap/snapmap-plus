...
param(
    [string[]]$Sources = @("dllmain.c", "host_image.c", "signatures.c", "engine_globals.c", "hook.c", "smoke.c",
                           "rawmap.c", "editor_frame.c", "map_shards.c", "map_package.c", "map_embed.c", "navmesh.c", "nav_regions.c", "nav_bake.c", "nav_traversal.c", "aas_edit.c", "aas_augment.c", "palette_guard.c", "palette_refresh.c", "engine_dialog.c", "package_conflicts.c", "strids.c",
