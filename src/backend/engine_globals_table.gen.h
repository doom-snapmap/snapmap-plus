...
const global_entry BACKEND_ENGINE_GLOBALS[] = {
    { .name = "cmd_system_slot",
      ...
      .anchor = "48 8B 0D ?? ?? ?? ?? 48 8D 15 ?? ?? ?? ?? 48 8B 01 FF 50 50 48 8B 0D ?? ?? ?? ?? 48 8D 15 ?? ?? ?? ?? 48 8B 01 48 83 C4 28",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x55B7280u },

    { .name = "cvar_system_slot",
      ...
      .anchor = "48 8B 0D ?? ?? ?? ?? 48 8D 15 ?? ?? ?? ?? 45 33 C0 0F 28 F0 48 8B 01 FF 50 60 33 C9 F3 0F 11 73 08 0F 28 74 24 40 88 43 1C 48 8B C3 F3 0F 11 7B 0C 0F 28 7C 24 30 F3 44 0F 11 43 10 44 0F 28 44 24 20 89 0B 48 89 4B 14",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x55B7290u },

    { .name = "decl_resource_head",
      ...
      .anchor = "48 89 35 ?? ?? ?? ?? 48 89 6E 08 4C 89 76 10 48 8B C6 48 8B 8C 24 40 08 00 00 48 33 CC",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x6217F90u },

    { .name = "decl_visibility_manager",
      ...
      .anchor = "48 8B 0D ?? ?? ?? ?? 48 8B 01 BA 0F 00 00 00 FF 90 B0 00 00 00 44 89 6C 24 30 48 8B 96 90 01 00 00",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x5557090u },

    { .name = "declmgr_accessor",
      ...
      .anchor = "E8 ?? ?? ?? ?? 48 8B 10 48 8B C8 FF 52 20 48 8B 10 48 8B C8 FF 52 20 48 8B D8",
      .disp_slot = 1, .disp_tail = 0, .delta = 0, .pinned_rva = 0x17F7030u },

    { .name = "editor_singleton",
      ...
      .anchor = "48 8D 0D ?? ?? ?? ?? 48 89 05 ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 05 ?? ?? ?? ?? 48 89 05 ?? ?? ?? ?? 48 83 C4 28",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x3056748u },
    ...
    { .name = "error_state",
       ...
       * Resolves to Vulkan 0x6DDE19C / OpenGL 0x56e4a0c; 1 of 1 reference sites agreed. */
      .anchor = "0F B6 05 ?? ?? ?? ?? C3 CC CC CC CC CC CC CC CC 48 83 EC 28 48 83 3D ?? ?? ?? ?? 00 74 15",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x6DDE19Cu },

    { .name = "game_manager_slot",
      ...
      .anchor = "48 8B 05 ?? ?? ?? ?? 48 63 CB 48 8D 14 49 48 8B CE 48 C1 E2 04 48 03 90 E0 53 04 00",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x56FFB90u },
    ...
    { .name = "idlist_grow",
      ...
      .anchor = "E8 ?? ?? ?? ?? 84 C0 74 17 48 63 46 10 3B 46 14 7D 0E 48 8B C8 48 8B 46 08 48 89 3C C8 FF 46 10 48 8B 5C 24 50",
      .disp_slot = 1, .disp_tail = 0, .delta = 0, .pinned_rva = 0x699A60u },
    ...
    { .name = "last_error_msg",
      ...
      .anchor = "48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 15 ?? ?? ?? ?? 48 8D 4D A1 E8 ?? ?? ?? ?? CC 41 B8 00 08 00 00 48 8D 15 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 15 ?? ?? ?? ?? 48 8D 4D A1 E8 ?? ?? ?? ?? 90 48 8B 4D F0 48 33 CC E8 ?? ?? ?? ??",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x6DDD990u },
    ...
    { .name = "load_state",
      ...
      .anchor = "89 0D ?? ?? ?? ?? C3 CC CC CC CC CC CC CC CC CC E9 ?? ?? ?? ?? CC",
      .disp_slot = 2, .disp_tail = 0, .delta = 0, .pinned_rva = 0x6DDE198u },

    { .name = "main_thread_id",
      /* engine main-thread id (DWORD).
       * Anchor: cmp qword ptr [rip + 0x53e1876], rax at Vulkan 0x19fc913 (unique on both images).
       * Resolves to Vulkan 0x6DDE190 / OpenGL 0x56e4a00; 5 of 5 reference sites agreed. */
      .anchor = "48 39 05 ?? ?? ?? ?? 74 07 32 C0 48 83 C4 28 C3 B0 01",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x6DDE190u },

    { .name = "material_manager_ctx",
      ...
      .anchor = "48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 89 86 F0 1B 00 00 48 8B 86 E8 1B 00 00 48 89 86 E0 1B 00 00 41 B0 01",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x59BD9D0u },
    ...
    { .name = "palette_vtable",
      ...
      .anchor = "48 8D 0D ?? ?? ?? ?? 48 89 08 C7 40 20 00 00 05 00 4C 89 70 10 4C 89 70 18 C7 40 40 00 00 05 00 4C 89 70 30 4C 89 70 38 C7 40 58 00 00 05 00 4C 89 70 48 4C 89 70 50 48 8D 87 C0 06 02 00 48 89 44 24 68",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x20499A0u },

    { .name = "provider_vtable",
      ...
      .anchor = "48 8D 05 ?? ?? ?? ?? 48 89 01 33 FF C7 41 18 00 00 33 00 48 89 79 08 48 89 79 10",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x27984A0u },

    { .name = "render_world_slot",
      ...
      .anchor = "4C 8D 05 ?? ?? ?? ?? 48 8B D7 48 8B CB F2 48 0F 2A C0 48 8B 45 70 48 89 44 24 28",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x57216F0u },

    { .name = "resource_manager_ctx",
      ...
      .anchor = "48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 89 86 B8 A0 29 00 4C 89 B6 08 5C 28 00 C7 86 10 5C 28 00 00 00 80 BF 4C 89 B6 CC A1 29 00",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x59BD8F0u },
    ...
    { .name = "shell_ptr_slot",
      ...
      .anchor = "48 8B 0D ?? ?? ?? ?? 48 8D 05 ?? ?? ?? ?? 48 89 84 24 C8 00 00 00 48 8D 54 24 30 C7 84 24 D0 00 00 00 D8 01 00 00 C6 84 24 D4 00 00 00 00",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x4DF7FC8u },

    { .name = "throw_suppressor_a",
      /* level-6 dispatcher throw gate A.
       * Anchor: cmp dword ptr [rip + 0x6c8a721], 0 at Vulkan 0x3250f8 (unique on both images).
       * Resolves to Vulkan 0x6FAF820 / OpenGL 0x58b6090; 6 of 6 reference sites agreed. */
      .anchor = "83 3D ?? ?? ?? ?? 00 0F 84 ?? ?? ?? ?? 48 8B 0D ?? ?? ?? ?? 48 8B 01 FF 90 30 03 00 00 48 8B 10 48 8B C8 FF 52 28",
      .disp_slot = 2, .disp_tail = 1, .delta = 0, .pinned_rva = 0x6FAF820u },

    { .name = "throw_suppressor_b",
      /* level-6 dispatcher throw gate B.
       * Anchor: cmp dword ptr [rip + 0x55a6052], 0 at Vulkan 0x1a09857 (unique on both images).
       * Resolves to Vulkan 0x6FAF8B0 / OpenGL 0x58b6120; 1 of 1 reference sites agreed. */
      .anchor = "83 3D ?? ?? ?? ?? 00 0F 85 ?? ?? ?? ?? 41 83 FF 07 0F 8C ?? ?? ?? ?? 48 8B 05 ?? ?? ?? ?? 48 85 C0",
      .disp_slot = 2, .disp_tail = 1, .delta = 0, .pinned_rva = 0x6FAF8B0u },

    { .name = "throwinfo_fatal",
      ...
      .anchor = "48 8D 15 ?? ?? ?? ?? 48 8D 4C 24 30 E8 ?? ?? ?? ?? CC 41 B8 00 08 00 00 48 8D 95 B0 05 00 00",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x2DED990u },

    { .name = "throwinfo_recoverable",
      ...
      .anchor = "48 8D 15 ?? ?? ?? ?? 48 8D 4D A1 E8 ?? ?? ?? ?? CC 41 B8 00 08 00 00 48 8D 15 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 15 ?? ?? ?? ?? 48 8D 4D A1 E8 ?? ?? ?? ?? 90 48 8B 4D F0",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x2DED690u },
    ...
    { .name = "type_container",
      ...
      .anchor = "48 8D 15 ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 3D ?? ?? ?? ?? 48 89 7C 24 30 48 8D 1D ?? ?? ?? ?? 48 89 5C 24 28",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x3082B10u },
    ...
    { .name = "validator_manager",
      ...
      .anchor = "48 8B 0D ?? ?? ?? ?? 48 8B 01 FF 90 40 02 00 00 48 8B C8 48 89 5C 24 28 48 8D 1D ?? ?? ?? ??",
      .disp_slot = 3, .disp_tail = 0, .delta = 0, .pinned_rva = 0x4DF9648u },
    ...
    { .name = "vis_leaf_lo",
      ...
      .anchor = "E8 ?? ?? ?? ?? 84 C0 0F 84 ?? ?? ?? ?? 45 33 FF 44 38 BF E4 02 00 00 41 0F 95 C7",
      .disp_slot = 1, .disp_tail = 0, .delta = 0, .pinned_rva = 0xD32A30u },
