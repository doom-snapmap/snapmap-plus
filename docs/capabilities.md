...
| `sh_navmesh` | Report the baked AI navigation the loaded map is serving — which modules and nav classes are in effect, and for anything refused, why. |
