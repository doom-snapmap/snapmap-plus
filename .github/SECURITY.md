...
- The changelog drafter's API key lives in a branch-restricted environment used
  by a job with no write permission. Worker credentials are stored separately
  in Cloudflare. Both are inventoried in [`docs/services.md`](../docs/services.md).
